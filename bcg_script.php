...
<table align ="left">
	<tr>
		<td>
			<h3><font color = "#808080">BigCityGuide<br>Revision 1.1 11/24/2011</font></h3>
		</td>
	</tr>
</table>
<br><br><br>
<div class = "sub_content_script">
	<table align ="left" bgcolor = "#F4F6F5">
		<tr>
			<td>
				<div class = "intro"><b>INTRO</b></div>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				...
				We make a free downloadable application for iPhone and Android users to help them search for locations such as restaurants, caf�, hotels, bed and breakfast and tourist attractions and <b>[mention their business type].</b><br><br> 
		...
		<tr>
			<td>
				<div class = "intro"><b>OFFER and PRICE</b></div>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<div class = "intro_2"><b>BUSINESS INFORMATION CAPTURE</b></div>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<div class = "intro"><b>CC VERIFICATION</b></div>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<div class = "key">
				...
				Caravan and Camp Sites<br>
				Delicatessens & Wine Merchants<br>
				Petrol Stations<br>
				Taxi Companies<br>
				Cash Machines<br>
				Car Park<br>
		...
		<tr>
			<td>
				...
				Once a business has agreed on phone, add the business by logging in here: <br><br>
				
				<a target = "_blank" href = "http://www.bigcityguide.co.uk/BusinessPortal/">http://www.bigcityguide.co.uk/BusinessPortal</a><br><br>
				
				( user: chris.leaver, pass: bigcity )<br><br>
				
				Add all the * info, press submit, and login details will be emailed.
			</td>
	</table>
</div>
